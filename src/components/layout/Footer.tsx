          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-sm text-muted-foreground">+91 9049102636</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-primary shrink-0 mr-2" />
                <span className="text-sm text-muted-foreground"><a href="mailto:worqubeofficial@gmail.com">worqubeofficial@gmail.com</a></span>
              </li>
            </ul>
          </div>
